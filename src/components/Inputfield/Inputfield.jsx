...
function Inputfield({
  ...
  return (
    <div className='w-full flex relative flex-col gap-1'>
      ...
      <input type={type} className={`px-3 py-5 rounded-lg bg-transparent placeholder:text-orange-300 text-black outline-none border border-orange-300 focus:border-orange-600 duration-200 w-full ${className}`}
        ref={ref} id={id}
        {...props} />
